...
fn zh(key: &str) -> &'static str {
    match key {
        ...
        "flow.node.if_text" => "文字条件",
        "flow.node.click_text" => "点击文字",
        ...
        "flow.field.needle" => "目标文字",
        "flow.field.match_exact" => "完全相等（否则包含即可）",
        "flow.field.case_sensitive" => "区分大小写",
...
fn en(key: &str) -> &'static str {
    match key {
        ...
        "flow.node.if_text" => "Text if",
        "flow.node.click_text" => "Click text",
        ...
        "flow.field.needle" => "Target text",
        "flow.field.match_exact" => "Exact match (else contains)",
        "flow.field.case_sensitive" => "Case sensitive",
        ...
        "scribe.btn.gen_flow" => "Build click flow",
